...
flags.DEFINE_integer("input_dim", 3, "Dimension of input [10]")
flags.DEFINE_integer("output_dim", 3, "Dimension of output [10]")
flags.DEFINE_integer("min_length", 2, "Minimum length of input sequence [1]")
flags.DEFINE_integer("max_length", 5, "Maximum length of output sequence [10]")
